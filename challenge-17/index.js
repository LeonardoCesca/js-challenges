...
(() => {
    ...
    */
    ...
    no console:
    */
    console.log( 'Adicionando seu nome no texto: ' + text.replace(/Manuel Marques de Sousa/, 'Leonardo Cesca'));
    // ?
    ...
    */
    ...
    console.log( '\nTrocando de "D" a "h" por "0":' + text.replace(/[D-Za-h]/g, '0'));
    // ?
    ...
    */
    console.log( '\n"O Centauro de Luvas" em caixa alta:' + text.replace(/O Centauro de Luvas/gi, (texto) => texto.toUpperCase()));
    // ?
    ...
    */
    const getMonthNumber = (month) => {
        let arrayMonths = ['janeiro', 'fevereiro', 'março', 'abril', 'maio', 'junho', 
        'julho', 'agosto', 'setembro', 'outubro', 'novembro', 'dezembro'];

       let number = (arrayMonths.indexOf(month) + 1).toString();
