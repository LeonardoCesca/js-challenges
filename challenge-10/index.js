...
const calculator = (op) => {
    ...
    return (arg1, arg2) => {
        if (typeof arg1 !== number || typeof arg2 !== number) return false;
...
const mult = calculator(operationSignal);
...
const er = calculator(operationSignal);

if(er) {
    number1 = 55;
    number2 = 100;

    console.log(showOperationMessage(operationSignal, number1, number2), er(number1, number2));
} else {
    console.log(showErrorMessage(operationSignal));
}
